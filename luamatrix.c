...
{
	if(lua_ismatrix(L, 1))
		*(lua_newmatrix(L)) = MatrixNegate(*(matrix_t *)lua_topointer(L, 1));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_ismatrix(L, 1))
		lua_pushnumber(L, MatrixDeterminant(*(matrix_t *)lua_topointer(L, 1)));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_ismatrix(L, 1))
		lua_pushnumber(L, MatrixTrace(*(matrix_t *)lua_topointer(L, 1)));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_ismatrix(L, 1))
		*(lua_newmatrix(L)) = MatrixTranspose(*(matrix_t *)lua_topointer(L, 1));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_ismatrix(L, 1))
		*(lua_newmatrix(L)) = MatrixInverse(*(matrix_t *)lua_topointer(L, 1));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_isvector(L, 1))
		*(lua_newvector(L)) = VectorNegate(*(vector_t *)lua_topointer(L, 1));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_isvector(L, 1))
		lua_pushnumber(L, VectorMagnitude(*(vector_t *)lua_topointer(L, 1)));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_isvector(L, 1))
		*(lua_newvector(L)) = VectorHomo(*(vector_t *)lua_topointer(L, 1));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_isvector(L, 1))
		*(lua_newvector(L)) = VectorThree(*(vector_t *)lua_topointer(L, 1));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_isvector(L, 1) && lua_isvector(L, 2))
		lua_pushnumber(L, VectorDistance(
			*(vector_t *)lua_topointer(L, 1),
			*(vector_t *)lua_topointer(L, 2)));
	else
		return luaL_error(L, "invalid argument type.\n");
...
{
	if(lua_isvector(L, 1) && lua_isvector(L, 2))
		*(lua_newvector(L)) = VectorPlusVector(
			*(vector_t *)lua_topointer(L, 1),
			*(vector_t *)lua_topointer(L, 2));
	else
		return luaL_error(L, "invalid argument type.\n");
...
{
	if(lua_isvector(L, 1) && lua_isvector(L, 2))
		*(lua_newvector(L)) = VectorMinusVector(
			*(vector_t *)lua_topointer(L, 1),
			*(vector_t *)lua_topointer(L, 2));
	else
...
int _G_vector_times(lua_State *L)
{
	...
	{
		*(lua_newvector(L)) = VectorTimesScalar(
			*(vector_t *)lua_topointer(L, 1),
			lua_tonumber(L, 2));
	}
	...
	{
		*(lua_newvector(L)) = VectorTimesVector(
			*(vector_t *)lua_topointer(L, 1),
			*(vector_t *)lua_topointer(L, 2));
	}
	else
...
{
	if(lua_isvector(L, 1) && lua_isvector(L, 2))
		lua_pushnumber(L, VectorDotVector(
			*(vector_t *)lua_topointer(L, 1),
			*(vector_t *)lua_topointer(L, 2)));
	else
		return luaL_error(L, "invalid argument type.\n");
...
{
	if(lua_isvector(L, 1) && lua_isvector(L, 2))
		*(lua_newvector(L)) = VectorCrossVector(
			*(vector_t *)lua_topointer(L, 1),
			*(vector_t *)lua_topointer(L, 2));
	else
		return luaL_error(L, "invalid argument type.\n");
...
{
	if(lua_isvector(L, 1))
		*(lua_newvector(L)) = VectorNormalize(*(vector_t *)lua_topointer(L, 1));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
...
{
	if(lua_isvector(L, 1))
		*(lua_newvector(L)) = VectorClamp(*(vector_t *)lua_topointer(L, 1));
	else
		return luaL_error(L, "invalid argument type.\n");
	return 1;
}
